    ...
    <body>
        ...
        <div id="line-one">
            <div class="container">
                ...
                <div class="row">  
                    <br>
                    <h4 id="center"><b>ALTERAÇÃO DOS DADOS DO SÓCIO</b></h4>
                    <br> 
                    <form method="post" 
                          action="{{route('socio.update', $socio->id)}}" 
                        ...
                        <div class="col-md-6">              
                            <div class="form-group">
                                ...
                                <input type="text" name="nome" 
                                       class="form-control" 
                                       value="{{$socio->nome or old('nome')}}"
                                       required>
                            </div>

                            <div class="form-group">
                                <label for="exampleFormControlSelect1">Selecione o clube</label>
                                <select class="form-control" id="clube" name="clube_id">
                                    @foreach($clubes as $clube)
                                        <option value="{{$clube->id or old('id')}}">{{$clube->nome or old('nome')}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
