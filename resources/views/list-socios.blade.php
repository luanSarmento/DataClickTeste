                    ...
                    <div class="col-md-12">
                        ...
                        <a href="{{route('socio.create')}}" 
                           class="btn btn-default btn-sm pull-right">
                            <span class="glyphicon glyphicon-plus"></span> Adicionar sócio</a>
                    </div>           
                </div>
                <div class="row">
                    <div class="col-md-12">   
                        <br />
                        <h4 id="center"><b>Sócios cadastrados ({{$total}})</b></h4>
                        <br>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td id="center">{{$socio->id}}</td>
                                        <td title="Nome">{{$socio->nome}}</td>
                                        <td title="Clube">{{$socio->clube->nome}}</td>
                                        
                                        <td id="center">
                                            <a href="{{route('socio.edit', $socio->id)}}" 
                                               data-toggle="tooltip" 
                                               data-placement="top"
                                               title="Alterar"><i class="fa fa-pencil"></i></a>
                                            &nbsp;<form style="display: inline-block;" method="POST" 
                                                        action="{{route('socio.destroy', $socio->id)}}"                                                        
